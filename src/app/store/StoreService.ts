...
import { connect, init, web3AuthOptions } from '../infrastructure/web3Auth/web3Auth';
import { Dispatch } from 'react';
import { FirebaseAuthAction, Web3AuthAction } from './StoreProvider';
import { getAuthentication, getToken} from '../service/authentication/authentication';
...
export const getFirebaseAuthDispatch = () => {

}

export const getWeb3AuthDispatch = () => {};